...
///////////////////////////////////////////////////////////////////////////////
static bool saveStartVTT(Score* score, const QString& fileRoot, std::set<int>* setVTT)
{
    ...
    for (std::set<int>::iterator i = setVTT->begin(); i != setVTT->end(); ++i)
