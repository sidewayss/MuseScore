...
// [This file is constantly undergoing changes, and that means it's the kind
...
//                break;
        ...
        case EType::STAFF_TEXT : {
            SubStyleId ss = SubStyleId(static_cast<const Text*>(e)->subtype());
            if (isMulti && (ss == SubStyleId::MEASURE_NUMBER
                         || ss == SubStyleId::SYSTEM)) {
