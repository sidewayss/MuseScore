...
//      Q_PROPERTY(QQmlListProperty<Ms::Part>     parts             READ qmlParts)
   ...
   private:
      ...
      QPageSize*   _pageSize;
      QMarginsF*   _pageOddMargins;
      QMarginsF*   _pageEvenMargins;
   ...
   public:
      ...
      QPageLayout* pageLayout()      { return _pageLayout;  }
      QMarginsF*   pageOddMargins()  { return _pageOddMargins; }
      QMarginsF*   pageEvenMargins() { return _pageEvenMargins; }
